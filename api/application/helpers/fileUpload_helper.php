...
*
**/
function imageUpload($field_name = '', $target_folder = '', $file_name = '', $thumb = FALSE, $thumb_folder = '', $thumb_width = '', $thumb_height = ''){

    if (!file_exists($target_folder)) {
        mkdir($target_folder,755);
    }

    if (!file_exists($thumb_folder)) {
        mkdir($thumb_folder,755);
    }
